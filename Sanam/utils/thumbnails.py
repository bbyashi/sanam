...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Sanam/assets/font2.ttf", 30)
        font = ImageFont.truetype("Sanam/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Sanam/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Sanam/assets/play_icons.png")
